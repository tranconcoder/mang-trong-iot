...
#define SENSOR_PROPERTY_ID_2        0x005C  /* Present Indoor Ambient Humidity */
 ...
 */
static int8_t temperature = 20;     /* Indoor temperature is 20 Degrees Celsius */
static int8_t humidity = 50;    /* Outdoor temperature is 30 Degrees Celsius */
static int8_t light_level = 0; /* Indoor humidity is 20% */
