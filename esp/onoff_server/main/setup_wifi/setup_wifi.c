...
// Default WiFi credentials - can be overridden
// These should ideally be configured via menuconfig/sdkconfig
#define EXAMPLE_ESP_WIFI_SSID      "Tran Con"
...
esp_err_t setup_wifi_sta(const char *ssid, const char *password)
{
    ...
    ESP_LOGI(TAG, "setup_wifi_sta finished.");
    ...
    // No need to delete the event group here if it's used to signal connection status
